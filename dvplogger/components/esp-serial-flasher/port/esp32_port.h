...
typedef struct {
  ...
  // added by E.Araki for custom boot, reset pins
  void (*loader_boot_init_func)(void);
  void (*loader_reset_init_func)(void);
  void (*loader_port_reset_target_func)(void);
  void (*loader_port_enter_bootloader_func)(void);

...
public:
        ...
        static const uint8_t epDataIn1Index; // DataIn endpoint index
        static const uint8_t epDataOut1Index; // DataOUT endpoint index
        static const uint8_t epInterruptIn1Index; // InterruptIN  endpoint index
        ...
        uint8_t RcvData1(uint16_t *nbytesptr, uint8_t *dataptr);
        uint8_t SndData1(uint16_t nbytes, uint8_t *dataptr);

...
#ifdef MAX3421E_SS  // if pins are defined explicitly use them
  #ifdef MAX3421E_INT
    typedef MAX3421e<MAX3421E_SS,MAX3421E_INT> MAX3421E;
  #endif
#else
...
#elif defined(ESP32) 
typedef MAX3421e<P5, P17> MAX3421E; // ESP32 boards  // for original hardware setup
...
//template<typename MAX3421E_TYPE> 
//class USB : public MAX3421E_TYPE {

...
#include <string.h>
struct Cp932Map { uint16_t sjis; uint16_t unicode; };
static const Cp932Map cp932_map[] = {
  {0x8140, 0x3000},
  {0x8141, 0x3001},
  {0x8142, 0x3002},
  {0x8143, 0xFF0C},
...
static uint16_t lookup_cp932(uint16_t sjis) { int lo=0, hi=(int)(sizeof(cp932_map)/sizeof(cp932_map[0]))-1; while(lo<=hi){int mid=lo+(hi-lo)/2; if(cp932_map[mid].sjis==sjis)return cp932_map[mid].unicode; if(cp932_map[mid].sjis<sjis)lo=mid+1; else hi=mid-1;} return 0xFFFD; }
